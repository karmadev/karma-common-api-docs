...
- **TypeScript SDK** — Official SDK for common integration tasks

## Quick Start

Install the SDK (optional) or call the API directly:
...
SDK on npm: [@karmalicious/karma-api-js](https://www.npmjs.com/package/@karmalicious/karma-api-js).
